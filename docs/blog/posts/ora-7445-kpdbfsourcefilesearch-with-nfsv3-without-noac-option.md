...
categories:
  - Oracle
date:
  created: 2021-11-12T02:14:00
description: >-
  An undocumented ORA-07445 kpdbfSourceFileSearch can be encountered while cloning a PDB on NFS without Direct NFS in use.
  The solution is to add the noac option to the NFS mount.
tags:
  - 19c
  - OERR
  - OS
...
Creating a pluggable database (PDB) by plugging an unplugged PDB in 19.12 can fail with the `ORA-7445 kpdbfSourceFileSearch` error.
