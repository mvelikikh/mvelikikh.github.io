...
categories:
  - Oracle
date:
  created: 2023-03-25T17:23:00
description: >-
  This post explains how to get X$ table columns from the Oracle binary.
  Firstly, it shows where the data is stored.
  Then, it shows how to obtain the same using the xinfo tool.
tags:
  - 21c
  - Code symbol
  - X$
...
The [xinfo](/tools.md#xinfo) tool has a `describe` command that produces the same data:
